...
local function createGui()
    ...
    Utils.createGuiElement("TextLabel", {Name = "Title", Size = UDim2.new(1, -80, 0, 30), Position = UDim2.new(0, 10, 0, 5), BackgroundTransparency = 1, Text = "Lava", TextColor3 = Color3.new(1, 1, 1), TextSize = 24, Font = Enum.Font.SourceSansBold, Parent = mainFrame})
